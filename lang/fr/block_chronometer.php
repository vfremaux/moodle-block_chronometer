...
$string['reset'] = 'RAZ';
$string['loaddotmatrix'] = 'Télécharger la fonte DotMatrix !!';
$string['daytag'] = 'j';

$string['fontsize'] = 'Taille de police';
$string['configfontsize'] = 'Taille de la police d\'horloge';
$string['allowstudentcontrol'] = 'Donner le contrôle à l\'étudiant';
